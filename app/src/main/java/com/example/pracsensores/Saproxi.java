...
public class Saproxi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saproxi);
        ...
        if (misensor == null) {
            Toast.makeText(Saproxi.this, "No se detecto el sensor ", Toast.LENGTH_SHORT).show();
            finish();
        } else {
            Toast.makeText(Saproxi.this, "El sensor se a detectado", Toast.LENGTH_SHORT).show();
        }
